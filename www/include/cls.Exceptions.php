...
final class Exceptions extends Exception{
	...
	public static function appException($Exception){
		$officeIPPool = array('96.90.222.145','96.90.222.146','96.90.222.147','96.90.222.148');
		$ip = http::getIP();
		if(defined( 'CliEenvironment' ))$ip='96.90.222.145';
		
		header("cache-control:no-cache,private");
		
		//有管理权限或启用调试的用户，或在命令行模式下，可以查看错误信息
		if( (!empty($_SESSION ['UserLevel']) || defined( 'DEVELOPMODE' ) || defined( 'CliEenvironment' )) && in_array( $ip, $officeIPPool )) {
