...
foreach($list as $value){
	if(in_array($value,array('include','js','data','upload','cache','.svn'))) continue;
	if( is_dir( $serveroot."/".$value ) ){
		if(isset($skip)){
...
function publish(){
	...
	$localip = isset($_GlobalConfig['host'])?$_GlobalConfig['host']:'127.0.0.1';
