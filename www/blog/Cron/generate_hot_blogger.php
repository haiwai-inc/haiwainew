...
class generate_hot_blogger{
    function start(){
        ...
        $rs_blog_blogger=$this->obj_blog_blogger->getAll(['id','userID','count_buzz','count_article','count_comment','count_read','description'],['status'=>1,'limit'=>200,'order'=>['count_read'=>'DESC']]);
