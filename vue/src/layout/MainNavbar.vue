    ...
    <template slot="navbar-menu">
      ...
      <profile-drop-down
        ...
        <nav-link to="/backend" v-if="$store.state.user.userinfo.UserLevel==2">
          <i class="icon" v-html="icons.setting" style="top:-1px"></i> {{$t('message').topnav.admin}}
        </nav-link>
        ...
        <nav-link to="/bookmark">
         <i class="icon" v-html="icons.star_small" style="top:-2px"></i>{{$t('message').topnav.myfavorite}}
        </nav-link>
        <nav-link to="/notices?id=1">
          <i class="icon" v-html="icons.message"></i> {{$t('message').topnav.mycomment}}
        </nav-link>
        <nav-link to="/notices?id=2">
          <i class="icon" v-html="icons.mail" style="top:-1px"></i> {{$t('message').topnav.myqqh}}
        </nav-link>
         <nav-link to="/notices?id=3">
          <i class="icon" v-html="icons.follower" style="top:-1px"></i> {{$t('message').topnav.myfuns}}
        </nav-link>
         <nav-link to="/notices?id=4">
          <i class="icon" v-html="icons.like_outline" style="stroke:#6a6a6a;top:-1px"></i> {{$t('message').topnav.likeme}}
        </nav-link>
        <hr class="mb-2 mt-1">
        <nav-link to="/profile/?id=1">
          <i class="icon" v-html="icons.setting" style="top:-1px"></i> {{$t('message').topnav.profile}}
        </nav-link>
        <hr class="mb-1 mt-1">
...
export default {
  ...
  methods:{
    ...
    //             objs[i].textContent = this.Exchange(objs[i].textContent);
    //         } else if (objs[i].nodeType === 1 && !this.stopDOM.includes(objs[i].tagName)) {
    //             this.translateBody(objs[i]);
    //         }
    //     }
    // },
    // Exchange(text) {
