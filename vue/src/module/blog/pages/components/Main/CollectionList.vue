<template>
  <div class="collection-box">
    ...
    <div class="collection-title d-flex justify-content-between">
      <h4>{{title}}</h4>
      <el-button v-if="$store.state.user.userinfo.bloggerID==data[0].bloggerID" type="text" link v-bind:style="{paddingRight:0 }" @click="go()"><i class="el-icon-setting"></i> 博文管理</el-button>
    </div>
