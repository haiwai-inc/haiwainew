    ...
    <div class="row editorbox">
      <div class="col-md-9 editor mx-auto col-12" id="editor_container" ref="editorContainer">
        <div class="d-flex justify-content-between py-2" ref="titleBox">
          ...
          <el-popover
            ...
            {{user.userinfo.bubble.instruction.blog_editor_video}}
            </p>
             <div style="text-align: right; margin: 0">
               2/4
                <el-button class="ml-3" type="primary" round size="mini" @click="removeBubble('blog_editor_pic')">知道了</el-button>
              </div>
      ...
      <div class="col-md-3" style="padding-top:20px">
        <div class="mb-3">
          <el-popover
            placement="bottom"
            ref="blog_editor_manage"
            v-model="bubbles.blog_editor_manage"
            width="300"
            popper-class="bubble"
            trigger="manual"
            >
            <p v-if="user.userinfo.bubble">{{user.userinfo.bubble.instruction.blog_editor_manage}}</p>
             <div style="text-align: right; margin: 0">
               1/4
                <el-button class="ml-3" type="primary" round size="mini" @click="removeBubble('blog_editor_manage')">知道了</el-button>
              </div>
        ...
        <el-popover
            placement="bottom"
            ref="blog_editor_category"
            v-model="bubbles.blog_editor_category"
            width="300"
            popper-class="bubble"
            trigger="manual"
            >
            <p v-if="user.userinfo.bubble">{{user.userinfo.bubble.instruction.blog_editor_category}}</p>
             <div style="text-align: right; margin: 0">
               3/4
        ...
        <div class="py-4">
          ...
          <el-popover
            placement="bottom"
            ref="blog_editor_tag"
            v-model="bubbles.blog_editor_tag"
            width="300"
            popper-class="bubble" v-else
            >
            <p v-if="user.userinfo.bubble">{{user.userinfo.bubble.instruction.blog_editor_tag}}</p>
             <div style="text-align: right; margin: 0">
               4/4
...
// tag 相关
    ...
    showBubble(){
      ...
      console.log(bubbles.blog_editor_manage)
    },
    removeBubble(type){
  ...
  data() {
    ...
    return {
      ...
      bubbles:{
        blog_editor_manage:false,
        blog_editor_category:false,
        blog_editor_pic:false,
        blog_editor_tag:false
      },
