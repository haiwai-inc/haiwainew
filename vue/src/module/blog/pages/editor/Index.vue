      ...
      <div class="col-md-3" style="padding-top:20px">
        <div class="mb-3">
          <el-popover
            ...
            trigger="manual"
            >
            <p>{{user.userinfo.bubble.instruction.blog_editor_manage}}</p>
             <div style="text-align: right; margin: 0">
               1/4
        ...
        <el-popover
            ...
            trigger="manual"
            >
            <p>{{user.userinfo.bubble.instruction.blog_editor_category}}</p>
             <div style="text-align: right; margin: 0">
               3/4
        ...
        <div class="py-4">
          ...
          <el-popover
            ...
            >
            <p>{{user.userinfo.bubble.instruction.blog_editor_tag}}</p>
             <div style="text-align: right; margin: 0">
               4/4
